...
@optgroup.option("-a", "--add", is_flag=True, default=False, help="Add RPZ PTR record")
@optgroup.option(
    "-u", "--update", is_flag=True, default=False, help="Update RPZ PTR record"
)
@optgroup.option(
    "-d", "--delete", is_flag=True, default=False, help="Delete RPZ PTR record"
)
