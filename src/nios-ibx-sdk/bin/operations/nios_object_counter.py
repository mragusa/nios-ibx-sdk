...
@optgroup.option(
    "--debug", default=False, is_flag=True, help="enable verbose debug output"
)
def main(grid_mgr: str, username: str, wapi_ver: str, debug: bool) -> None:
    ...
    for x in infoblox_obj_types:
        ...
        if ibx_objects.status_code != 200:
            ...
            final_object_count += len(ibx_obj_results["result"])
    print("Total Objects Found: {}".format(final_object_count))
